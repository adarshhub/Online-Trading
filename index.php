...
include "config/config.php"; 
    ...
    if(isset($_GET['asset'])){
        ...
        $asset = $_GET['asset'];
       echo "<script>loadAsset('$asset')</script>";

    }
?>

    <div id="asset-list-container" class="col-lg-6 col-md-12 col-sm-12" style="max-height: 88vh">
    ...
    <div id="asset-details-container" class="col-lg-6 col-md-12 col-sm-12">
        
        <div id="order-container" >
            <h2 class="display-4"><span id="asset-name">Asset Name</span></h2>
            <div id="sell-orders-box" class="col-lg-6">
                <h3>Sell Orders</h3>
            ...
            <div id="buy-orders-box" class="col-lg-6">
                <h3>Buy Orders</h3>
        ...
        <div id="trade-container">
            <div id="sell-box" class="col-lg-6">
